...
DECLARE @OLD_VERSION VARCHAR(10) = '1.0.0.0'
DECLARE @NEW_VERSION VARCHAR(10) = '1.0.0.1'
...
BEGIN
	...
	BEGIN TRY
		...
		*/
		...
		IF NOT EXISTS(SELECT 1 From INFORMATION_SCHEMA.COLUMNS Where TABLE_NAME = 'User' AND COLUMN_NAME = 'ExpireTime')
		BEGIN
			ALTER TABLE [dbo].[User] Add [ExpireTime] DATETIME null
		END
