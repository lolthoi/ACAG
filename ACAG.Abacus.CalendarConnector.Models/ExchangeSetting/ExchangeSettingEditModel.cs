...
{
  public class ExchangeSettingEditModel
  {
    ...
    [RegularExpression("^\\s*[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})\\s*$", ErrorMessageResourceName = LangKey.MSG_THE_EMAIL_FIELD_IS_NOT_A_VALID_EMAIL_ADDRESS, ErrorMessageResourceType = typeof(Resource))]
